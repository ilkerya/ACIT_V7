...
namespace EEV_Sim {
	...
	/// </summary>
	public ref class EndApp : public System::Windows::Forms::Form
	{
	public:
		EndApp(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(EndApp::typeid));
			...
			this->button1->Location = System::Drawing::Point(56, 96);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(80, 40);
			this->button1->TabIndex = 0;
			this->button1->Text = L"YES";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &EndApp::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(192, 96);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(80, 40);
			this->button2->TabIndex = 1;
			this->button2->Text = L"NO";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &EndApp::button2_Click);
			// 
			// label1
			// 
			...
			this->label1->Text = L"Do You Really Want  To  Exit\?";
			// 
			// EndApp
			// 
